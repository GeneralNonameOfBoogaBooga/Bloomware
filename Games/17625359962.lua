local Bloomware = getgenv().Bloomware
local Windows = Bloomware.UIData

--// Services (CACHED)
local Players = Bloomware.cloneref(game:GetService("Players"))
local Lighting = Bloomware.cloneref(game:GetService("Lighting"))
local Workspace = Bloomware.cloneref(game:GetService("Workspace"))
local RunService = game:GetService("RunService")

local attacking = false

local LocalPlayer = Players.LocalPlayer
local PlayerGui = Bloomware.cloneref(LocalPlayer:WaitForChild("PlayerGui"))
...
local function addESP(character)
	if not character:FindFirstChild("BloomwareESP") then
		local highlight = Instance.new("Highlight")
		highlight.Name = "BloomwareESP"
		highlight.Parent = character
	end
end

local function removeESP(character)
	local esp = character:FindFirstChild("BloomwareESP")
	if esp then
		esp:Destroy()
	end
end
